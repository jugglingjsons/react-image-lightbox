  ...
  _createClass(ReactImageLightbox, [{
    ...
    value: function loadAllImages() {
      ...
      this.getSrcTypes().forEach(function (srcType) {
        ...
        if (props[type] && !_this13.isImageLoaded(props[type]) && !(props[type] === 'mainSrc' && props.mainCustomContent) && !(props[type] === 'prevSrc' && props.prevCustomContent) && !(props[type] === 'nextSrc' && props.nextCustomContent)) {
    ...
    value: function render() {
      ...
      }, images), prevSrc || prevCustomContent ? React__default.createElement("button", {
      ...
      }) : null, nextSrc || nextCustomContent ? React__default.createElement("button", {
